    ...
    if chat_type != "private":
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('Get Help', url='https://t.me/Filmokamella')
                    ]
                ]
               )
            )
